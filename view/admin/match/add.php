                    ...
                    <?php if(isset($message)) echo $message; ?>
                            <form class="form-horizontal"  method="POST" enctype="multipart/form-data">
                              <div class="form-group">
                                <label class="control-label col-sm-2" for="title">Trận đấu</label>
                                <div class="col-sm-10">
                                  <input name="match" type="text" class="form-control" id="title">
                                </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  ...
                                  <i style="font-size: 10px">*VD:30/4*</i>
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input name="hour" type="text" class="form-control" id="title">
                                  <i style="font-size: 10px">*VD:10h30-12h30*</i>
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input name="loc" type="text" class="form-control" id="title">
                                </div>
                              </div>
