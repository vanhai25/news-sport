...
<head>
  ...
  <link rel="stylesheet" href="../public/admin/assets/css/all.css">
  <link rel="stylesheet" href="../public/admin/assets/css/fontawesome.css">
          ...
          <ul class="nav-right">
                  ...
                  <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
                    <li>
                      <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                        <div class="peer mR-15"><img class="w-3r bdrs-50p" src="../public/admin/assets/images/1.jpg" alt=""></div>
                    ...
                    <li>
                      <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                        <div class="peer mR-15"><img class="w-3r bdrs-50p" src="../public/admin/assets/images/2.jpg" alt=""></div>
                        <div class="peer peer-greed">
                    ...
                    <li>
                      <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                        <div class="peer mR-15"><img class="w-3r bdrs-50p" src="../public/admin/assets/images/3.jpg" alt=""></div>
                        <div class="peer peer-greed">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
                <div class="peer mR-10"><img class="w-2r bdrs-50p" src="../public/admin/assets/images/10.jpg" alt=""></div>
                <div class="peer"><span class="fsz-sm c-grey-900"><?php if(isset($_SESSION['uid'])) echo $_SESSION['ten']; ?></span></div>
              </a>
