                    ...
                    <?php if(isset($message)) echo $message; ?>
                            <form class="form-horizontal"  method="POST" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input name="number" type="number" value="<?=$data->number?>" class="form-control" id="title">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input name="pos" type="text" value="<?=$data->position?>" class="form-control" id="title">
                                </div>
                              </div>
                              ...
                              <div class="form-group" >
                                ...
                                <div class="col-sm-10" style="margin-top: 10px">
                                  <textarea id="content" name="content" rows="14" class="form-control" id="desc"><?=$data->information?></textarea>
                                </div>
                              </div>
